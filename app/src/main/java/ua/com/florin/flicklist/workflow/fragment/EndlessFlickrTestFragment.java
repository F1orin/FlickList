...
import ua.com.florin.flicklist.workflow.async.LoadPhotoListTask;
...
import ua.com.florin.flicklist.workflow.view.RecyclingImageView;
...
public class EndlessFlickrTestFragment extends Fragment {
    ...
    private ua.com.florin.flicklist.workflow.adapter.ImageAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new ua.com.florin.flicklist.workflow.adapter.ImageAdapter(getActivity(), mImageList, mImageFetcher);

 ...
 * {@link ua.com.florin.flicklist.complete.util.ImageWorker} class and its subclasses. Use
 * {@link ImageCache#getInstance(FragmentManager, ImageCacheParams)} to get an instance of this
 * class, although usually a cache should be added directly to an {@link ua.com.florin.flicklist.complete.util.ImageWorker} by calling
 * {@link ua.com.florin.flicklist.complete.util.ImageWorker#addImageCache(FragmentManager, ImageCacheParams)}.
 */
